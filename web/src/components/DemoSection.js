  ...
  return (
    <div>
      <section className={classNames('section')}>
        <div
          style={{ marginTop: 30 }}
          className="container container--medium mb-5 text-center"
        >
          <h2 className="section__title mt-0">$15.532,12 Invested</h2>
        </div>
        <div
          className="container"
          style={{
        ...
        <div className="container">
          <table>
            <tbody>
              ...
              <tr>
                <th>Dealing Settlement</th>
                <td>Trade Date + 3 days</td>
              </tr>
              <tr>
                <th>Use of Income</th>
                <td>Accumulating</td>
